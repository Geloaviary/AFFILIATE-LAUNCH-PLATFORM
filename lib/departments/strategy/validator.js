    ...
    if (!Array.isArray(payload.top5)) {
        ...
        violations.push(
            ...
            buildViolation({
                ...
                message: "Top opportunities are missing."
    ...
    if (!payload.strategy) {
        ...
        violations.push(
            ...
            buildViolation({
                ...
                message: "Strategy package is missing."
    ...
    if (!payload.metadata) {
        ...
        violations.push(
            ...
            buildViolation({
                ...
                message: "Strategy metadata is missing."
    ...
    violations.push(
        ...
        buildViolation({
            ...
            message:
                ...
                "Strategy contains no opportunities."
...
function buildValidationReport(
    ...
    Array.isArray(
        ...
        context.artifact.payload.top5

    )

        ? context.artifact.payload.top5.length
