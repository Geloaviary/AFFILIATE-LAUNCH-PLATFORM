...
function isStrategyPayload(
    ...
    isObject(payload.marketIntelligence) &&

    isObject(payload.campaignIntelligence) &&

    isObject(payload.productIntelligence)
...
function summarizeStrategyArtifact(
    ...
    hasMarketIntelligence:
        ...
        Boolean(
            ...
            artifact.payload.marketIntelligence
