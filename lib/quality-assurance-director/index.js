...
function composeServices() {
    ...
    if (runtime.state.servicesComposed) {
        return;
    }

    runtime.state.servicesComposed = true;

    ServiceContainer.singleton({
        type: "service",
        name: "quality-service",
        factory: () => QualityService
    });
...
function bootstrap() {
    ...
    if (runtime.state.bootstrapped) {
        return runtime.director;
    }

    // Lock bootstrap immediately
    runtime.state.bootstrapped = true;
