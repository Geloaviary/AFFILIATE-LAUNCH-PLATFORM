...
function discoverDepartments() {
    ...
    /*
    ==============================================
    Constitutional Rule RTBT-002

    Explicit Runtime Department Admission

    Directory existence does not grant Runtime
    participation.

    Only departments explicitly admitted below may
    enter Runtime verification and registration.

    During Reference Department construction,
    Strategy is the sole admitted business
    department.
    ==============================================
    */

    const admittedDepartments =
